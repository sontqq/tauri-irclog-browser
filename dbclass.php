<?php /*
    ...
    along with this program.  If not, see <http://www.gnu.org/licenses/>. */ class DB {
  // initial connection
  ...
  protected function preparseQueryParams() {
    ...
    foreach ($posList as $pos => $type) {
      ...
      // handle named parameters
        ...
        if (count($args_all) != 1 || !is_array($args_all[0])) $this->nonSQLError("If you use named parameters, the second argument must be an array of 
parameters");
