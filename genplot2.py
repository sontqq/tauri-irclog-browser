...
cur.execute("SELECT hour(whattime), COUNT(*) from irclog where whattime >= '2018-09-29 00:00:00' group by hour(whattime) order by hour(whattime);")
...
plt.savefig('/mnt/ramdisk/chart2.png', bbox_inches='tight')
os.chmod('/mnt/ramdisk/chart2.png', 0o777)
